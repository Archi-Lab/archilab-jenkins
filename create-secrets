...
docker secret create PROX_IP_WS2019_CERTS_SECRET ./secrets/PROX_IP_WS2019_CERTS_SECRET
docker secret create PROX_IP_WS2019_CERTS_CLIENT ./secrets/PROX_IP_WS2019_CERTS_CLIENT
docker secret create PROX_IP_WS2019_CERTS_CA_SERVER ./secrets/PROX_IP_WS2019_CERTS_CA_SERVER
...
docker secret create FAE_WS2019_CERTS_SECRET ./secrets/FAE_WS2019_CERTS_SECRET
docker secret create FAE_WS2019_CERTS_CLIENT ./secrets/FAE_WS2019_CERTS_CLIENT
docker secret create FAE_WS2019_CERTS_CA_SERVER ./secrets/FAE_WS2019_CERTS_CA_SERVER
