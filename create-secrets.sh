...
docker secret create PROX_GP_WS19_CERTS_SECRET ./secrets/PROX_GP_WS19_CERTS_SECRET
docker secret create PROX_GP_WS19_CERTS_CLIENT ./secrets/PROX_GP_WS19_CERTS_CLIENT
docker secret create PROX_GP_WS19_CERTS_CA_SERVER ./secrets/PROX_GP_WS19_CERTS_CA_SERVER
