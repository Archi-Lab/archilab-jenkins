...
docker secret create PROX_PP_SS2019_CERTS_SECRET ./secrets/PROX_PP_SS2019_CERTS_SECRET
docker secret create PROX_PP_SS2019_CERTS_CLIENT ./secrets/PROX_PP_SS2019_CERTS_CLIENT
docker secret create PROX_PP_SS2019_CERTS_CA_SERVER ./secrets/PROX_PP_SS2019_CERTS_CA_SERVER
...
docker secret create SONARQUBE_TOKEN ./secrets/SONARQUBE_TOKEN
